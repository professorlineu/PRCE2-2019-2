...
int main()
{
    ...
    cout << "Média dos salários: " << iMedSal1<<endl ;
    cout << "Média de número de filhos: " << iMedFil1<<endl ;

    cout << "Maior salário: " << Maior <<endl ;
    cout << "Das 20 pessoas entrevistadas, " << (100*f)/20 << " %, correpondem a mulheres com salário superior a R$ 1000,00." ;
}
